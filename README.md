...
можно запускать вручную через GitHub Actions. AI-иллюстрации намеренно генерируются без
текста и выдуманных логотипов. Настоящие логотипы допустимо добавлять только из проверенных
официальных бренд-материалов.
