...
Workflow `process_telegram_callbacks.yml` перезапускает обработчик кнопок каждые
15 минут и держит его онлайн между перезапусками. При временной ошибке генерации
кнопки исходного черновика автоматически восстанавливаются.
